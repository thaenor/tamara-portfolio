      ...
      <div className="pt-[122px] pb-12">
        <div className="max-w-7xl mx-auto px-12">
          <div className="flex gap-4 mb-8">
            <button onClick={handleBackClick} className="inline-flex items-center justify-center w-10 h-10 text-black hover:opacity-70 transition flex-shrink-0" style={{ paddingTop: '20px' }}>
